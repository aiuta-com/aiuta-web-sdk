...
export default function Generated() {
  ...
  const handleDetectContentScrollPosition = (event: UIEvent<HTMLDivElement>) => {
      ...
      if ('id' in element) {
        if (+element.id * GENERATED_IMAGE_HEIGHT === target.scrollTop) {
          if (miniSliderContentRef && miniSliderContentRef.current) {
            ...
            miniSliderContentRef.current.scrollTop = +element.id * SLIDE_ITEM_IMAGE_HEIGHT - 200
          }
        }
      }
    }
            ...
            <>
              ...
              >
                {generatedImages.length > 1 ? (
                  <div ref={miniSliderContentRef} className={styles.generatedImagesSlider}>

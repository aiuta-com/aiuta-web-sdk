    ...
    const response = await fetch(
      `https://api.aiuta.com/digital-try-on/v1/sku_items/aiuta-demo-store`,
      {
        ...
        headers: {
          ...
          Authorization:
            'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJkd0xXVXVsRjBxT2txcXBxUnV2RXlMT2s2ZUFPeEF5OCIsIm5iZiI6MTc1NTI1NTkyNSwiZXhwIjoxNzU1MjU5NTI1LCJpYXQiOjE3NTUyNTU5MjV9.bxg8NE1w3sa5mqHKwkC3mjhJ2KrXuIPGR_vbb5HDkPo',
        },
